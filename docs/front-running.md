...
```sh
curl -X POST -H 'Content-type: application/json' -d '{"jsonrpc": "2.0", "method": "zmk_txpool_search", "params":[{"to": "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D", "input": "0x38ed1739*"}], "id": 1}' https://api.zmok.io/fr/YOUR-APP-ID
...
```sh
curl -X POST -H 'Content-type: application/json' -d '{"jsonrpc": "2.0", "method": "zmk_txpool_query", "params":["('\''to'\'' = '\''0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45'\'' AND '\''input'\'' LIKE '\''0x5ae401dc%'\'' AND '\''value'\'' > '\''0x99'\'')"], "id": 1}' https://api.zmok.io/fr/YOUR-APP-ID
